...
Smart IDEs (such as VSCode or IntelliJ) require special configuration for TypeScript to work when using [Yarn PnP](/concepts/pnp) installs. This page is a collection of settings for each editor we've looked into.
...
<div class="[&_table]:table-fixed [&_th:first-child]:w-[350px]">
...
Zed has [native support](https://zed.dev/docs/languages/yarn) for Yarn Plug'n'Play after the base SDK is installed.
