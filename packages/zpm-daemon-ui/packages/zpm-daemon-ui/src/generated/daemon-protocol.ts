...
export type TaskfileError = {workspace: string, message: string};
 ...
 */
  attachedLongLived: Array<AttachedLongLivedTask>;} | {type: `taskOutput`, taskId: string, lines: Array<BufferedOutputLine>} | {type: `taskStopped`, success: boolean, error: string | null} | {type: `longLivedTaskList`, tasks: Array<LongLivedTaskInfo>} | {type: `declaredTaskList`, tasks: Array<DeclaredTaskInfo>, errors: Array<TaskfileError>} | {type: `contextCancelled`, cancelledCount: number} | {type: `taskHistory`, events: Array<TaskEvent>} | {type: `stats`;
    /**
 ...
 */
    watchedFilesCount: number;} | {type: `authUrl`, url: string} | {type: `shuttingDown`} | {type: `error`, message: string};
