...
mod tests {
    ...
    #[test]
    fn keeps_windows_paths_absolute_across_roots() {
        assert_eq!(
            Path::from_str("/D:/fixtures/no-deps").unwrap().relative_to(&Path::from_str("/C:/project/node_modules").unwrap()),
            Path::from_str("/D:/fixtures/no-deps").unwrap(),
        );

        assert_eq!(
            Path::from_str("/C:/project/.store/no-deps").unwrap().relative_to(&Path::from_str("/C:/project/node_modules").unwrap()),
