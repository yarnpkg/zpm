...
use zpm_primitives::{Descriptor, Ident, Locator, PeerRange, PythonTargetEnv, Range, Reference, RegistryReference, RegistrySemverRange, SemverDescriptor};
    ...
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        ...
        for (island_id, island) in &self.islands {
            ...
            for (fork_id, fork) in &island.forks {
                ...
                for (descriptor, locator) in &fork.resolutions {
